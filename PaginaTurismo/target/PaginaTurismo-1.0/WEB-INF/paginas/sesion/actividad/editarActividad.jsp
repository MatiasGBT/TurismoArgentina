...
<html>
    <head>
        ...
        <title>Editar actividad | Turismo Argentina</title>
    </head>
    <body id="cuerpo__formulario__actividad" class="cuerpo__formulario">
        <h1>Editar Actividad</h1>
        <div>
            <form action="${pageContext.request.contextPath}/ServletPanel?accion=modificarActividad&idActividad=${actividad.idActividad}" method="POST" id="formulario__sesion" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="submit" value="Editar actividad">
                </div>
            </form>
        </div>
