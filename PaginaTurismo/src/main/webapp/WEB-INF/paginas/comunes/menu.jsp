<header class="header">
    <nav class="nav">
        ...
        <ul class="nav__menu">
            ...
            <li class="nav__menu__item"><a href="${pageContext.request.contextPath}/ServletControlador?accion=sesion" class="nav__menu__link"><i class="fas fa-shopping-cart"></i> Carrito</a></li>
        </ul>
    </nav>
</header>